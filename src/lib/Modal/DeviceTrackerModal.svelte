			...
			{#if !apiKey || loadError}
				<div class="notice">
					...
					<span class="text">
						...
						{/if}
						<a
							href="https://github.com/KinDR007/ha-fusion/blob/main/static/documentation/Map.md"
							target="_blank"
						>
							https://github.com/KinDR007/ha-fusion/blob/main/static/documentation/Map.md
						</a>
					</span>
				</div>
			{/if}
